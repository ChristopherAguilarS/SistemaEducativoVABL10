    ...
    <div class="header-content">
      ...
      <div class="responsive-logo">
        <a class="responsive-logo-dark" href="index.html" aria-label="Brand"><img
            src="{{asset('src/assets/img/brand-logos/desktop-logo.png')}}" alt="logo" class="mx-auto"></a>
        <a class="responsive-logo-light" href="index.html" aria-label="Brand"><img
            src="{{asset('src/assets/img/brand-logos/desktop-dark.png')}}" alt="logo" class="mx-auto"></a>
      </div>
              ...
              <div class="hs-dropdown-menu ti-dropdown-menu border-0 w-[20rem]" aria-labelledby="dropdown-profile">
                <div class="ti-dropdown-header !bg-primary flex">
                  <div class="ltr:mr-3 rtl:ml-3">
                      <img class="avatar shadow-none rounded-full !ring-transparent" src="{{ Avatar::create(Auth::user()->name)->toBase64() }}" />
                  </div>
                  <div>
                    <p class="ti-dropdown-header-title !text-white">{{ Auth::user()->name }}</p>
                    <p class="ti-dropdown-header-content !text-white/50">{{ Auth::user()->area->descripcion }}</p>
                  </div>
                </div>
